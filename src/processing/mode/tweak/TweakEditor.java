...
{
	TweakModeWithHonours tweakMode;
	...
	protected TweakEditor(Base base, String path, EditorState state,
		...
		tweakMode = (TweakModeWithHonours) mode;
		
		// random port for OSC (0xff0 - 0xfff0)
		//oscPort = (int)(Math.random()*0xf000) + 0xff0;
		oscPort = 9999; // always the same. to help with working with combobox from processing tool.
...
/////////////////////////////////////////////////////////////////////////////////////////////
	...
	public void createJComboBoxWindow() {
...
///////////////////////////////////////////////////////////
        ...
        header += "  }\n" + // end of oscEvent(OscMessage msg).
                  "}\n"; // end of TweakMode_OscHandler class.
    	...
    	header += "void sendMessageViaOSC(OscMessage msg) {\n" + 
    			  "  tweakmode_oscP5.send(msg, new NetAddress(\"127.0.0.1\", 12001));\n" + 
    			  "}\n";
